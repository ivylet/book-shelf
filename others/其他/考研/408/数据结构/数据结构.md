...
![在这里插入图片描述](20201108225433872.png)
...
**二叉树遍历算法的应用**
![在这里插入图片描述](2020110822593919.png)

![在这里插入图片描述](20201108225955514.png)


### 5.5.2、线索二叉树

![在这里插入图片描述](20201108230020645.png)
...
![在这里插入图片描述](20201108230035981.png)
...
![在这里插入图片描述](20201108230050464.png)


> 再来看B：B的左孩子为空，则指向它的前驱，它的前驱根据后序遍历的结果是D，所以B的左孩子指向D
> B的右孩子不为空

![在这里插入图片描述](20201108230108364.png)


> 再来看E，E的左孩子为空，则指向它的前驱结点B,E的右孩子为空，则指向它的后继结点F

![在这里插入图片描述](20201108230126352.png)


> 再来看F，它的左孩子为空，则指向它的前驱结点E。它的右孩子为空，则指向它的后继节点C

![在这里插入图片描述](20201108230144400.png)


线索二叉树的结点形式：![在这里插入图片描述](20201108230203744.png)
...
![在这里插入图片描述](20201108230224273.png)
...
![在这里插入图片描述](20201108230238570.jpg)

![在这里插入图片描述](20201108230252366.png)
...
![在这里插入图片描述](20201108230616522.png)
&nbsp;
孩子表示法
...
![在这里插入图片描述](20201108230631811.png)


### 5.6.2、森林与二叉树的转换
![在这里插入图片描述](20201108230822235.png)

**（1）转换：把每棵树转换为二叉树。（即根结点没有右孩子的二叉树）**
![在这里插入图片描述](20201108230835355.png)


**（2）连接：第一棵二叉树不动，从第二棵二叉树开始，依次把后一棵二叉树的根结点作为前一棵二叉树的根结点的右孩子，用线连接起来。**
![在这里插入图片描述](20201108230852896.png)


**（3）旋转**

![在这里插入图片描述](20201108230906698.png)
...
![在这里插入图片描述](20201108230920245.png)


**（1）逆旋转**

![在这里插入图片描述](20201108230934429.png)


**（2）抹线：从根结点开始，依次抹掉结点与右孩子的连线，直到结点没有右孩子为止**

![在这里插入图片描述](20201108230949972.png)


**（3）转换：将二叉树转换成树（也可以省略该步骤）**

![在这里插入图片描述](20201108231003266.png)
...
![在这里插入图片描述](20201108231020100.png)
...
![在这里插入图片描述](20201123173246672.png)
...
![在这里插入图片描述](20201108231342626.png)
...
![在这里插入图片描述](20201108231420140.png)
...
> 答案：D
>
> 解释：五种情况如下：![在这里插入图片描述](20201108231442608.png)
...
![在这里插入图片描述](20201110224740777.png)
...
![在这里插入图片描述](20201110224755815.png)
...
![在这里插入图片描述](20201110224836452.png)
...
![在这里插入图片描述](20201110224857882.png)
有向完全图
...
![在这里插入图片描述](20201110224923832.png)
...
![在这里插入图片描述](20201110224939105.png)
...
![在这里插入图片描述](20201110224954748.png)
...
![在这里插入图片描述](20201110225008613.png)
...
![在这里插入图片描述](20201110225021921.png)
...
![在这里插入图片描述](20201110225121332.png)
...
![在这里插入图片描述](20201110225138188.png)


![在这里插入图片描述](20201110225150707.png)
...
![在这里插入图片描述](20201110225205624.png)
有向树

 一个有向图的生成森林是由若干棵有向树组成，含有图中全部顶点，但只有足以构成若干棵不相交的有向树的弧

![在这里插入图片描述](202011102252198.png)
...
![在这里插入图片描述](20201110225234142.jpg)


&nbsp;

![在这里插入图片描述](20201110225247391.jpg)


&nbsp;

![在这里插入图片描述](20201110225300381.jpg)
...
![在这里插入图片描述](20201110225428436.png)


==对于有向图，邻接表又称正邻接表或出度表==

![在这里插入图片描述](2020111022544527.png)


![在这里插入图片描述](20201110225457782.jpg)


==有向图的逆邻接表又称入度表==

![在这里插入图片描述](20201110225510268.jpg)
...
![在这里插入图片描述](2020111023045224.png)
...
![在这里插入图片描述](20201110230511521.png)
...
![在这里插入图片描述](20201110230549649.png)
...
![在这里插入图片描述](20201110230604269.png)
...
![在这里插入图片描述](20201110230616286.png)
...
![在这里插入图片描述](20201110230628476.png)
...
![在这里插入图片描述](20201110230641332.png)

 

（5）队列头为C，C出队列。C的邻接顶点有B、D，但B、D均被标记。无元素入队列。当前位置指向C。

![在这里插入图片描述](20201110230708985.png)
...
![在这里插入图片描述](20201110230723581.png)
...
![在这里插入图片描述](20201110230735703.png)
...
![在这里插入图片描述](20201110230748496.png)
...
![在这里插入图片描述](20201110230801619.png)
...
![在这里插入图片描述](20201110230826192.png)


（1）选取A为起始点，输出A，将A入队列，标记A。

![在这里插入图片描述](20201110230838875.png)
...
![在这里插入图片描述](20201110230853290.png)
...
![在这里插入图片描述](20201110230904782.png)
...
![在这里插入图片描述](20201110230915717.png)
...
![在这里插入图片描述](20201110230927945.png)
...
![在这里插入图片描述](20201110230942403.png)
...
![在这里插入图片描述](20201110230954971.png)
...
![在这里插入图片描述](20201110231008467.png)
...
![在这里插入图片描述](20201110231020285.png)
...
![在这里插入图片描述](20201110231037353.png)
...
案例：
![在这里插入图片描述](20201114222012206.png)
...
> 首先关于树的生成树：
>
> ![在这里插入图片描述](20201114222219417.png)
...
![在这里插入图片描述](20201123172851877.png)
...
![在这里插入图片描述](20201114222252685.png)
...
![在这里插入图片描述](20201114222350493.jpg)
...
![在这里插入图片描述](20201114222405696.png)
...
举个例子，学习java系列的教程
![在这里插入图片描述](20201114222455319.png)
...
那上述序列可以简单表示为：
![在这里插入图片描述](20201114222510602.png)
...
![在这里插入图片描述](20201114222527392.png)
...
1：删除1或2，并输出
![在这里插入图片描述](20201114222541931.png)

2：删除2或3以及对应边
![在这里插入图片描述](20201114222553886.png)

3：删除3或者4以及对应边
![在这里插入图片描述](20201114222606481.png)

4：重复以上规则步骤
![在这里插入图片描述](2020111422262156.png)
...
![在这里插入图片描述](20201114222721345.png)



![在这里插入图片描述](2020111422273420.png)
...
![在这里插入图片描述](20201114222752943.png)
...
案例：![在这里插入图片描述](20201114222809384.png)


## 第六章小结

![在这里插入图片描述](20201114222821311.png)

![在这里插入图片描述](20201110231146474.png)
...
![在这里插入图片描述](20201110231159976.jpg)
...
![在这里插入图片描述](20201110231213630.jpg)
...
![在这里插入图片描述](20201114223106233.png)
# 七、查找

![在这里插入图片描述](20201122174444264.png)
...
![在这里插入图片描述](20201122174512741.png)
...
![在这里插入图片描述](20201122174529517.png)


![在这里插入图片描述](20201122174544361.png)


![在这里插入图片描述](20201122174559197.png)
...
![在这里插入图片描述](20201122174615506.png)


折半查找判定树过程：

![在这里插入图片描述](20201204111341639.png)





![在这里插入图片描述](20201122174647368.png)
...
![在这里插入图片描述](20201122174701317.png)
...
![在这里插入图片描述](2020112217471864.png)
...
![在这里插入图片描述](20201122174734486.png)
...
![在这里插入图片描述](20201122174854607.png)
...
![在这里插入图片描述](20201129232848986.png)
...
![在这里插入图片描述](20201129232915436.png)
...
![在这里插入图片描述](20201129232929589.png)
...
![在这里插入图片描述](2020112923301097.png)
...
![在这里插入图片描述](20201129233025260.png)
...
![在这里插入图片描述](20201129233037897.png)
...
![在这里插入图片描述](20201129233119962.png)
...
![在这里插入图片描述](20201129233134333.png)



![在这里插入图片描述](20201129233145525.png)
...
![在这里插入图片描述](20201129233255355.png)
...
![在这里插入图片描述](20201203214309472.png)
...
> ![在这里插入图片描述](2020120321432547.png)
...
![在这里插入图片描述](20201203214402803.png)
...
![在这里插入图片描述](20201203214625669.png)


线性表的查找：主要包括顺序查找、折半查找和分块查找，三者比较：

![在这里插入图片描述](20201203214638138.png)


二叉排序树和折半查找的比较

![在这里插入图片描述](2020120321464978.png)
...
![在这里插入图片描述](20201203214700931.png)
...
![在这里插入图片描述](20201203214717874.png)


![在这里插入图片描述](2020120321473057.png)


![在这里插入图片描述](20201203214743150.png)

![在这里插入图片描述](20201203214754841.png)
...
2. ==排序的稳定性==  ：能保证两个关键字相等的数，经过排序之后，其在序列的前后位置顺序不变。（A1=A2，排序前A1在A2前面，排序后A1还在A2前面），则称这种排序是稳定的。反之，若排序后前后位置顺序变化，则称这种排序是不稳定的![在这里插入图片描述](20201205180025105.png)

3. ==内部排序和外部排序==  ：待排序记录全部存放在计算机内存中进行排序的过程称为内部排序；在排序过程中需对外存进行访问的排序过程
4. 内部排序的过程是一个逐步扩大记录的有序序列长度的过程![在这里插入图片描述](20201205180042439.png)
...
![在这里插入图片描述](20201205180054412.png)
...
![在这里插入图片描述](20201206171636270.png)


把待排序的数据插入到已经排好序的数据中，直到所有的数据插入完成，即就是直接插入排序。

![在这里插入图片描述](2020120617165232.png)
...
![在这里插入图片描述](2020120617170960.png)
...
### 8.2.3、希尔排序
![在这里插入图片描述](20201206171934255.gif)
...
![在这里插入图片描述](20201206171834351.png)
...
![在这里插入图片描述](2020120617195914.gif)
...
![在这里插入图片描述](20201206172016905.png)
...
![在这里插入图片描述](20201206172707660.gif)
...
![在这里插入图片描述](20201206172723121.png)
...
![在这里插入图片描述](20201206172818661.png)
...
![在这里插入图片描述](20201206172834834.gif)
...
![在这里插入图片描述](20201206172909537.png)


同时，我们对堆中的结点按层进行编号，将这种逻辑结构映射到数组中就是下面这个样子

![在这里插入图片描述](20201206172923394.png)
...
![在这里插入图片描述](20201206172938954.png)


b.此时我们从下至上，从右到左找非叶子结点，转换为父节点大于子节点的状态

![在这里插入图片描述](20201206172955836.png)


c.找到第二个非叶节点4，由于[4,9,8]中9元素最大，4和9交换。

![在这里插入图片描述](20201206173010457.png)


这时，交换导致了子根[4,5,6]结构混乱，继续调整，[4,5,6]中6最大，交换4和6。

![在这里插入图片描述](20201206173024402.png)
...
![在这里插入图片描述](20201206173040930.png)


b.重新调整结构，使其继续满足堆定义

![在这里插入图片描述](20201206173054302.png)


c.再将堆顶元素8与末尾元素5进行交换，得到第二大元素8，并将8也标记为已标记状态

![在这里插入图片描述](20201206173107115.png)


后续过程，继续进行调整，交换，如此反复进行，最终使得整个序列有序

![在这里插入图片描述](20201206173119701.png)
...
![在这里插入图片描述](20201206173226482.gif)
...
![在这里插入图片描述](2020120617334749.png)

再来看看**治**阶段，我们需要将两个已经有序的子序列合并成一个有序序列，比如上图中的最后一次合并，要将[4,5,7,8]和[1,2,3,6]两个已经有序的子序列，合并为最终序列[1,2,3,4,5,6,7,8]，来看下实现步骤。

比较 i 和 j （即两组中各自的第一个元素），将小的元素放入到temp中

![在这里插入图片描述](20201206173400874.png)


![在这里插入图片描述](20201206173418584.png)

## 8.6、基数排序

![在这里插入图片描述](20201206173432497.gif)
...
![在这里插入图片描述](20201206173510782.jpg)


这些已经排好序的数据块我们称之为`顺串或者归并段`

![在这里插入图片描述](20201206173524877.png)
...
![在这里插入图片描述](20201206173545436.png)
...
![在这里插入图片描述](20201206173606139.png)

 将数据分为四段：

![在这里插入图片描述](20201206173617954.png)


然后将每段读入内存，排序后写入硬盘

![在这里插入图片描述](20201206173630803.jpg)


然后两两合并

![在这里插入图片描述](20201206173645909.png)


输出哪个元素，就在那个元素所在的顺串（或者叫组）再次读入元素

![在这里插入图片描述](20201206173658790.png)


![在这里插入图片描述](20201206173712449.png)

就这样，一直合并到两个顺串完，如果一个顺串先完，剩下另一个顺串，那么就将剩下的顺串直接拷贝到硬盘上。

按照这个方法，把合并后的顺串继续合并，直到最终合并成一个总的顺串，排序结束。

![在这里插入图片描述](20201206173724301.jpg)
...
![在这里插入图片描述](20201206173739691.png)

比如我们的例子，刚开始的时候顺串（初始顺串）有 4 个（m=4）,每次对 2 个顺串进行归并（k=2）,那么归并趟数就为:
![在这里插入图片描述](20201206173752736.png)
...
![在这里插入图片描述](20201206173823919.png)
...
![在这里插入图片描述](20201206173939898.png)


![在这里插入图片描述](20201206173952204.png)
...
>
> ![在这里插入图片描述](20201206174010454.png)
...
![在这里插入图片描述](20201206174027319.png)
...
![在这里插入图片描述](20201206174041503.png)


④ 冒泡排序

![在这里插入图片描述](20201206174054337.png)


⑤ 快速排序

![在这里插入图片描述](20201206174108630.png)


⑥ 简单选择排序

![在这里插入图片描述](20201206174122361.png)
...
![在这里插入图片描述](20201206174135614.png)
